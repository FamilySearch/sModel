#
#  Be sure to run `pod spec lint sModel.podspec' to ensure this is a
...
Pod::Spec.new do |s|
  ...
  s.description  = <<-DESC
  sModel is a Swfit framework written on top of FMDB to provides:
  ...
  # Or just: s.author    = "Stephen Lynn"
  # s.authors            = { "Stephen Lynn" => "stephen.g.lynn@gmail.com" }
  # s.social_media_url   = "http://twitter.com/Stephen Lynn"
  ...
  s.source       = { :git => "https://github.com/FamilySearch/sModel.git", :tag => "#{s.version}" }
